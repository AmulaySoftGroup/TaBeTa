...
public class TourGuide {
    ...
    /* Static builder */
    public static TourGuide init(GameActivity activity){
        return new TourGuide(activity);
    }

    /* Constructor */
    public TourGuide(GameActivity activity){
        mActivity = activity;
    }
    ...
    protected void setupView(final Typeface tf){
    ...
    private void startView(Typeface tf){
...
//        }
    ...
    private void setupToolTip(Typeface tf){
        ...
        if (mToolTip != null) {
            ...
            if (mToolTip.getCustomView() == null) {
                ...
                toolTipTitleTV.setTypeface(tf);
                toolTipDescriptionTV.setTypeface(tf);
