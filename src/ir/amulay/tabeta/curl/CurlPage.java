...
public class CurlPage {
	...
	/**
	 * Generates nearest power of two sized Bitmap for given Bitmap. Returns
	 * this new Bitmap using default return statement + original texture
	 * coordinates are stored into RectF.
	 */
	private void getTexture(Bitmap bitmap, RectF textureRect) {
		...
		// Bitmap bitmapTex = Bitmap.createBitmap(newW, newH,
		// bitmap.getConfig());
	 ...
	 * Bitmap.
	 */
	public void getTexture(RectF textureRect, int side) {
		switch (side) {
		case SIDE_FRONT:
			getTexture(mTextureFront, textureRect);
			break;
		default:
			getTexture(mTextureBack, textureRect);
		}
	}
	 ...
	 */
	public void reset() {
		// Log.e("ResetCoLoR", "COLOR RESETST");
		// mColorFront = Color.argb(230, 10, 85, 230);
		// mColorBack = Color.argb(230, 10, 85, 230);
